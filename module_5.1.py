class House:
    ...
    def __radd__(self, value):  #Методы __iadd__ и __radd__
        # не обязательно описывать заново, достаточно вернуть
        # значение вызова __add__.
        # КАК ИМЕННО вернуть значение вызова?
        self.number_of_floors += int(value)
        return self
